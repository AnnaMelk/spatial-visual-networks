...
Swarm(setup=setup,n=n,pos=pos,pos_center=pos_center,phi=phi, dist=d,noise_phi=nphi,noise_pos=npos,w=w,l=0.);


# In[5]:


mySwarm=Swarm(n=9, setup='hexagonal')
